      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {activities.map(({ key, icon: Icon, badge, watermark, hoverShadow }) => (
          <Reveal
            key={key}
            className={cn(
              "group relative flex flex-col gap-4 overflow-hidden rounded-xl border border-border bg-card p-6 shadow-soft transition duration-300 ease-brand hover:-translate-y-1 md:p-8",
              hoverShadow,
            )}
          >
            <Icon
